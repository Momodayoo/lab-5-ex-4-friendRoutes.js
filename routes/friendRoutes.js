...
router.put('/:id', (req, res) => {
    ...
    if (oldFriend) {
        let oldFriendIndex = friends.indexOf(oldFriend); // find the existing friend
        updatedFriend = {...oldFriend, ...updatedFriend}; // merge new details with old
        friends[oldFriendIndex] = updatedFriend; // replace old with new
